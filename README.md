...
The repository contains a [numerical validation and comparison with the UKF-UI [2]](./numerical_validation.m), a [sensitivity analysis on the noise level](./sensitivity_measurement_noise.m), and a [sensitivity analysis on the number of measurements](./sensitivity_number_measurement.m). In the examples, the analysed system is a 6-DOFs shear chain with hysteretic springs governed by the Bouc-Wen model.
